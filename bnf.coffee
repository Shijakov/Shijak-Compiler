...
ALLOC_ARR_TYPE ::= PRIMITIVE_TYPE [ MOD_EXPR ] ARRAY_EXTENSION

TYPE ::= PRIMITIVE_TYPE ARRAY_EMPTY_EXTENSION

ARRAY_EXTENSION ::= [ MOD_EXPR ] ARRAY_EXTENSION
ARRAY_EXTENSION ::= ''

ARRAY_EMPTY_EXTENSION ::= [ ] ARRAY_EMPTY_EXTENSION
