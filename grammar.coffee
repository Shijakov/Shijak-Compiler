...
STATEMENT ::= WHILE_STATEMENT   asdasd
STATEMENT ::= IF_STATEMENT  asdads
STATEMENT ::= BREAK_STATEMENT   asdads
STATEMENT ::= CONTINUE_STATEMENT    asdasd
STATEMENT ::= EXPRESSION_LIST   asdasd
STATEMENT ::= DEFINE_VAR
STATEMENT ::= INPUT_STATEMENT   asd
STATEMENT ::= OUTPUT_STATEMENT  adsdas
STATEMENT ::= ALLOC_ARR asdd
STATEMENT ::= FREE_ARR  asd
STATEMENT ::= RETURN_STATEMENT  asd
